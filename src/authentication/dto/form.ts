...
export class signupData {
  ...
  @IsEmail()
  @IsNotEmpty()
  @MaxLength(40, { message: "lastName must be at most 16 characters long" })
  email: string;
  ...
  @MaxLength(20, { message: "lastName must be at most 16 characters long" })
  @IsNotEmpty()
  @IsString()
  lastName: string;

  @MinLength(2, { message: "firstName must be at least 2 characters long" })
  @MaxLength(20, { message: "firstName must be at most 16 characters long" })
  @IsNotEmpty()
  @IsString()
  firstName: string;
}
